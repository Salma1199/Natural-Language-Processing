...
with open('mtrl_removed.json', 'r') as f:
    json_data = f.read()
...
def train_epoch(train_data, classifier, optimizer, criterion, batch_size):
    ...
    for batch in tqdm(train_loader):
        ...
        loss = criterion(outputs, targets)  # Calculate the loss using criterion
        loss.backward()
        optimizer.step()
...
for learning_rate, epochs, batch_size in itertools.product(learning_rate_list, epochs_list, batch_size_list):
    ...
    avg_loss = train_classifier(train_data, classifier, optimizer, criterion, epochs, batch_size)
...
# In your BERTClassifier class, use BertModel instead of SciBertModel
